...
public:
  ...
  bool ndt_bootstrap_pending_{false};
  bool have_good_pose_{false};
  ...
  bool lock_planar_{false};

  int ndt_max_iterations_{50};
  int far_point_boost_factor_{1};
  ...
  double map_odom_smoothing_{1.0};
  double pose_publish_frequency_{20.0};
  double last_align_stamp_s_{-1.0e9};

  geometry_msgs::msg::TransformStamped last_map_odom_tf_;
